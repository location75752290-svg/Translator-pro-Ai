# -*- coding: utf-8 -*-
# Part 1: Topics 1 - 10 (each with 50 unique sentences)
...
def get_topics():
    ...
    # Generate topics 1 through 10
    topics_meta = [
        (1, "Greetings & Introductions", "خیرمقدم اور تعارف", "chat", "Daily greetings, meeting people, and polite introductions.", t1_sentences),
        (2, "Family & Relationships", "خاندان اور تعلقات", "people", "Talk about parents, siblings, children, and relatives.", t2_sentences)
    ]
    
    # We will complete all 10 topics for part 1
    # Let's import the full part 1 helper
    import part1_complete
    return part1_complete.get_all_part1_topics()

print("Part 1 base initialized.")
