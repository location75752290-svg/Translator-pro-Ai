...
def write_kotlin_part(file_path, class_name, topics_slice):
    with open(file_path, "w", encoding="utf-8") as f:
        ...
        for t_idx, topic in enumerate(topics_slice):
            comma = "," if t_idx < len(topics_slice) - 1 else ""
